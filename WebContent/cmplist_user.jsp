...
<%SimpleDateFormat ft = new SimpleDateFormat ("dd-MM-yyyy");%>
	...
	<%
		...
		PreparedStatement psgst=Dataconnect.connectDB().prepareStatement("select * from company WHERE team_id = ? ORDER BY cmp_name ASC");
		psgst.setInt(1, (Integer) session.getAttribute("team_id"));
