			...
			<font size="2" face="calibri" >
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
					...
					<th width="15%" style="text-align: center">Cess Login Id</th>
					<th width="15%" style="text-align: center">Cess Password</th>
					<th width="15%" style="text-align: center">Cess Prv Pass Changed</th>
					<th width="15%" style="text-align: center">Cess Prv Pass</th>
                </tr>
                </thead>
                <tbody>
				<% 
...
--%>
				    ...
				    <td><%=rsgst.getString("cess_login_id")%></td>
				    <td><%=rsgst.getString("cess_login_pass")%></td>
				    <td><%=ft.format(rsgst.getDate("cess_pass_changed_on"))%></td>
				    <td><%=rsgst.getString("cess_prv_pass")%></td>
                ...
                <tr>
					<th style="text-align: center">Name</th>
					<th style="text-align: center">Cess Login Id</th>
					<th style="text-align: center">Cess Password</th>
					<th style="text-align: center">Cess Prv Pass Changed</th>
					<th style="text-align: center">Cess Prv Pass</th>
                </tr>
                </tfoot>
              </table>
              </font>
