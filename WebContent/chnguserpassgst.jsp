      ...
      <div class="box box-info">
        <div class="box-body">
	   		<table border=1 style="width:100%">
	    		...
	    		<tr>
	    		<td align="center">Enter New GST Password</td>
	    		<td>
			    <input type="text" id='gst_pass' maxlength="20" style="width:100%; border: none">	
	    		</td>
	    		</tr>
	    	</table>
				<div class="box-footer clearfix" style="float-bottom; height:100%">
					<button type="button" class="btn btn-info" onclick="chnggstpass();">Change GST Password</button>
				</div>
...
<script>
	function chnggstpass() {
		...
		gst_pass = document.getElementById('gst_pass').value;

		$.ajax({	
        url: "Servebserp?action=chnggstpass",//your jsp page name
        method: "POST",//HTTP method.
        data: {cmp:cmp, gst_pass:gst_pass},//sending request to state.jsp page.
		success: function (data)
        {
				swal(cmp_nam, 'GST Pass changed Sucessfully', 'success');
        }
        });
	};
</script>
